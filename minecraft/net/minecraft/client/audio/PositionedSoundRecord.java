...
public class PositionedSoundRecord extends PositionedSound {
	public static PositionedSoundRecord create(final ResourceLocation soundResource, final float pitch) { return new PositionedSoundRecord(soundResource, 0.25F, pitch, false, 0, ISound.AttenuationType.NONE, 0.0F, 0.0F, 0.0F); }

	public static PositionedSoundRecord create(final ResourceLocation soundResource) { return new PositionedSoundRecord(soundResource, 1.0F, 1.0F, false, 0, ISound.AttenuationType.NONE, 0.0F, 0.0F, 0.0F); }
	...
	private PositionedSoundRecord(final ResourceLocation soundResource, final float volume, final float pitch, final boolean repeat, final int repeatDelay, final ISound.AttenuationType attenuationType, final float xPosition, final float yPosition,
