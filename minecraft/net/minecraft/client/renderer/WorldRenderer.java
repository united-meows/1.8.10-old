...
public class WorldRenderer {
	...
	public void sortVertexData(final float p_181674_1_, final float p_181674_2_, final float p_181674_3_) {
		...
		if (this.quadSprites != null) {
			...
			for (int j2 = 0; j2 < ainteger.length; ++j2) { final int k2 = ainteger[j2]; atextureatlassprite[j2] = this.quadSprites[k2]; }
	...
	public int getBufferSize() { return this.vertexCount * this.vertexFormat.getIntegerSize(); }
	 ...
	 */
	public int getColorIndex(final int p_78909_1_) { return ((this.vertexCount - p_78909_1_) * this.vertexFormat.getNextOffset() + this.vertexFormat.getColorOffset()) / 4; }
	...
	public WorldRenderer color(final float red, final float green, final float blue, final float alpha) { return this.color((int) (red * 255.0F), (int) (green * 255.0F), (int) (blue * 255.0F), (int) (alpha * 255.0F)); }
	...
	public ByteBuffer getByteBuffer() { return this.modeTriangles ? this.byteBufferTriangles : this.byteBuffer; }

	public VertexFormat getVertexFormat() { return this.vertexFormat; }

	public int getVertexCount() { return this.modeTriangles ? this.vertexCount / 4 * 6 : this.vertexCount; }

	public int getDrawMode() { return this.modeTriangles ? 4 : this.drawMode; }

	public void putColor4(final int argb) { for (int i = 0; i < 4; ++i) this.putColor(argb, i + 1); }

	public void putColorRGB_F4(final float red, final float green, final float blue) { for (int i = 0; i < 4; ++i) this.putColorRGB_F(red, green, blue, i + 1); }

	public void putSprite(final TextureAtlasSprite p_putSprite_1_) {
		if (this.animatedSprites != null && p_putSprite_1_ != null && p_putSprite_1_.getAnimationIndex() >= 0) this.animatedSprites.set(p_putSprite_1_.getAnimationIndex());
		if (this.quadSprites != null) {
			final int i = this.vertexCount / 4;
	...
	public void setSprite(final TextureAtlasSprite p_setSprite_1_) {
		if (this.animatedSprites != null && p_setSprite_1_ != null && p_setSprite_1_.getAnimationIndex() >= 0) this.animatedSprites.set(p_setSprite_1_.getAnimationIndex());
		if (this.quadSprites != null) this.quadSprite = p_setSprite_1_;
	}

	public boolean isMultiTexture() { return this.quadSprites != null; }
	...
	public EnumWorldBlockLayer getBlockLayer() { return this.blockLayer; }
	...
	public void quadsToTriangles() {
		if (this.drawMode == 7) {
			if (this.byteBufferTriangles == null) this.byteBufferTriangles = GLAllocation.createDirectByteBuffer(this.byteBuffer.capacity() * 2);
			if (this.byteBufferTriangles.capacity() < this.byteBuffer.capacity() * 2) this.byteBufferTriangles = GLAllocation.createDirectByteBuffer(this.byteBuffer.capacity() * 2);
	...
	public boolean isColorDisabled() { return this.noColor; }
	...
	public class State {
		...
		public int[] getRawBuffer() { return this.stateRawBuffer; }

		public int getVertexCount() { return this.stateRawBuffer.length / this.stateVertexFormat.getIntegerSize(); }

		public VertexFormat getVertexFormat() { return this.stateVertexFormat; }
	}
}
